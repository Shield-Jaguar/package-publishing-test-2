...
export interface ConfigurationsTypeScriptUpsertCommand {
  isEnabled?: boolean;
...
export const configurationsTypeScriptUpsertCommandSchema: Schema<ConfigurationsTypeScriptUpsertCommand> = object(
  {
